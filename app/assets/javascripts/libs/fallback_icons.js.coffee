...
@iUPB.fontsAvailable = ->
  if window.iUPB.vars.fontsAvailable is undefined
    ...
    if ((android_version != null) and (android_version[1])) and ((android_version[1].indexOf("4.0") != -1) or (android_version[1].indexOf("4.2") != -1) or (android_version[1].indexOf("4.3") != -1))
